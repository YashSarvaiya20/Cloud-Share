...
export const testimonials = [
  {
    ...
    quote:
      "CloudShare has transformed how our team collaborates on creative assets. The secure sharing and intuitive interface make our workflow seamless.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    ...
    quote:
      "As a freelancer, I need to share large design files with clients securely. CloudShare's simple sharing has been a game-changer.",
    rating: 5,
  },
  {
    name: "Priya Sharma",
    ...
    quote:
      "Managing project files across multiple teams used to be a nightmare until we found CloudShare. Highly recommended!",
    rating: 4,
  },
];

//side menubar options
import {
  LayoutDashboard,
  Upload,
  Files,
